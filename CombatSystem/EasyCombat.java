...
/**
 * The EasyCombat class implements the ICombat interface and represents an
 * easy level of combat in an adventure-based system. It includes methods to
...
public class EasyCombat implements ICombat {
    ...
    /**
     * Constructor for EasyCombat class with a specified player.
     *
     * @param player - An object of PlayerCreator representing the player in combat.
     */
    public EasyCombat(PlayerCreator player) {
        this.actions = new ArrayList<>(List.of(new swingStick()));
        this.player = player;
    ...
    /**
     * Default constructor for EasyCombat class with no specified player.
     */
    public EasyCombat() {
        this.actions = new ArrayList<>(List.of(new swingStick()));
        this.player = null;
